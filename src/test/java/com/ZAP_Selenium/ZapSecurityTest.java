...
private static final String ZAP_PROXYHOST = "13.127.39.165";
...
// 	  System.out.println("Waiting for ZAP...");
	 ...
	 public static void generateZapReport() throws Exception {
	  ...
	  fos.write(zapScanner.getHtmlReport());
	 }
...
//     zapSpider.excludeFromSpider(WebSiteNavigation.LOGOUT_URL);
    ...
    zapSpider.spider("http://15.206.178.135:8081/bodgeit/");
    ...
    zapScanner.scan("http://15.206.178.135:8081/bodgeit/");
